...
function Resources_Calculater_Step_4({ setStep, formData, setFormData, progressValue, priviousProgressValue }: any) {
    ...
    return <div className="Resources_Calculater_Step_4">
            ...
            <div className="Resources_Calculater_Step_4 popup_conatiner md:pt-[29px] sm:pt-[20px] pt-[12px] lg:pb-[66px] md:pb-[55px] sm:pb-[40px] pb-[25px] xl:px-[50px] lg:px-[40px] md:px-[30px] sm:px-[20px] px-[10px] relative bg-white">
                ...
                <div className="form_details max-w-[750px] mx-auto md:justify-end justify-center grid gap-5 md:pb-[97px] sm:pb-[60px] pb-[30px] relative w-fit">
                    <div className="flex relative  md:justify-self-end   max-w-max ">
                        <div className="md:flex md:flex-row  max-w-max  items-center gap-x-[10px] sm:ps-0 ps-[11px]">
                    ...
                    <div className="flex  relative md:justify-self-end  max-w-max sm:ps-0 ps-[11px]">
                ...
                <div className="button text-center mb-[27px]">
                    <button className={`${style.calculator_btn} bg-color-1 font-mono text-base md:px-[40px] sm:px-[30px] px-[25px] md:py-[10px] py-[5px] text-white rounded-full  border border-color-1 active:bg-white active:text-color-1`} type='button' onClick={handleNextButtonClick}>Next</button>
                </div>
