      ...
      <div className="main_padding">
        ...
        >
          ...
          >
            ...
            <div className="text-white font-mono text-center max-w-[1172px] mx-auto min-tb:max-tb:px-[50px] px-6 md:px-10 " data-aos="fade-up" >
        ...
        <div className="main_padding">
          <div className={`${classes.growth_card_div}`}>
            <div className={`${classes.growth_card} relative max-w-[1335px] mx-auto -mt-[250px] min-tb:max-tb:-mt-[265px] md:-mt-[346px] `} id="tools">
