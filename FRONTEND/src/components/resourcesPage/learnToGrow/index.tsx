  ...
  return (
    <>
      ...
      >
        ...
        >
          <div
            className={`${classes.grow_img}  absolute max-w-[200px] md:max-w-[300px]`}
          >
            <Image
          ...
          <div className="text-white font-mono text-center max-w-[1172px] mx-auto p-6 md:p-10 ">
            <h2 className="text-40px md:text-45px font-semibold">
              {data.hero.title}
            </h2>
            <p className="text-25px md:text-30px  text-md py-[40px]">
      ...
      <div className="max-w-[1335px] mx-auto -mt-[350px] md:-mt-[279px]">
        <h2 className="font-mono font-semibold text-40px md:text-45px text-white mx-auto text-center">
          Tools
        </h2>
