          ...
          <div className="">
            <div className="xl:max-w-[971px] max-w-[800px] max-tb:max-w-[533px]">
              ...
              <Link href={data.buttonLink}>
                ...
                <button className={`${classes.btn} font-mono min-tb:max-tb:text-[16px] text-white bg-color-1 rounded-full  hover:text-color-1 hover:bg-white border border-color-1 `}>
                  {data.buttonName}
                </button>
              </Link>
            </div>
