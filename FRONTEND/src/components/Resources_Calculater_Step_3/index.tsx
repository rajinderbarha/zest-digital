...
// function Resources_Calculater_Step_3({ setStep, handleSubmit, setFormData }: any) {
...
//                                 <select id="industry" name="industry" className=" w-full font-lato border border-color-9 rounded-[10px] md:rounded-[15px] lg:rounded-[20px] md:px-[26px] sm:px-[15px] px-[10px]  md:py-[20px] sm:py-[15px] py-[10px] lg:text-[20px] md:text-[18px] text-[16px]  text-color-1 md:mt-[11px] mt-[7px]" onChange={(e) => setSelectedIndustry(e.target.value)} required>
...
function Resources_Calculator_Step_3({ setStep, setFormData }: any) {
    ...
    return (
        <>
            <div className="Resources_Calculator_Step_3">
                <div className="pe-[6px] pb-[6px]">
