...
function Resources_Calculater_Step_2() {
    return (
        <>
            <div className="Resources_Calculater_Step_2">
                <div className="sm:px-10 px-5">
                    <div className="Resources_Calculater_Step_2 popup_conatiner pt-[29px] pb-[66px]">
                        <div className="progrees_bar mb-[40px]">

                        </div>
                        <div className="heading text-center mb-[20px]">
                            <h2 className="font-mono text-30px md:text-40px lg:text-45px font-semibold mb-[23px]">Choose your business type</h2>
                            <p className="font-mono text-base font-normal text-center ">Select an option below:</p>
                        </div>
                        <div className="grid md:grid-cols-2 gap-10 mb-[70px] px-[50px] md:px-[100px] lg:px-[159px]">
                            <div className="col-span-1 max-w-[493px] text-center">
                                ...
                                <p className="font-mono text-25px md:text-30px font-normal mt-[26px]">We’re an ecommerce business and take payments directly through our website.</p>
                            </div>
                            <div className="col-span-1 max-w-[493px] text-center">
                                <div className="md:max-w-max max-w-[150px] text-center mx-auto">
                                    <Image src={letter_icon} alt='' className='mx-auto' />
                                </div>
                                <p className="font-mono text-25px md:text-30px font-normal mt-[26px]">We generate leads through our website and follow-up with a proposal.</p>
                            </div>
                        </div>
