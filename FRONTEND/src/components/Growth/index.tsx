        ...
        <>
            <div className="text-white mx-auto max-w-[1720px] w-full px-5 my-10">
                ...
                <div className={`${classes.growth_engine_box} mx-auto max-w-[1720px] w-full px-20 my-10 font-mono grid gap-10 -mt-64 relative`}>
                    <Growth_engine title="Growth Engine" desc="The fastest and most complete way to generate new leads and sales to grow your business. All-inclusive growth marketing covering; PPC, SEO, content, and more." />
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-10 max-w-[1345px] mx-auto ">
                        <Growth_engine title="Growth Curve" desc="Scalable on-demand growth marketing support across SEO, PPC, content, and more." />
                        <Growth_engine title="Growth Mapper" desc="Plan for your growth using our unique framework, available as a standalone online course or a facilitated expert workshop." />
                    </div>
                    <Growth_engine title="Growth Tracker" desc="The fastest and most complete way to generate new leads and sales to grow your business. All-inclusive growth marketing covering; PPC, SEO, content, and more." />
