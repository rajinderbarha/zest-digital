...
function ScheduleCall({ data }: { data: Schedule_a_call }) {
  ...
  return <div className={`${classes.ScheduleCall} main_padding xl:mb-[132px] lg:mb-[110px] md:mb-[80px] sm:mb-[60px] mb-[50px]`}>
    <div className="main_container" data-aos="fade-up">
      ...
      <div
        className={`${classes.bg_image} flex items-center max-tb:flex-col md:flex-row rounded-[15px] md:rounded-[20px] lg:rounded-30px px-[40px]  `}
        data-aos="fade-up">
