...
function Growths({ data, otherSolHeading }: any) {
  ...
  return <>
    {data.length > 0 && (
      <div className={`${classes.growth_card_container}`}>
        <div className={`${classes.growths_div} Growths max-w-[1365px] mx-auto `}>
          <div className={`${classes.growths_container} `}>
            ...
            <div className={`${classes.growth_card_div} ${classes.card_div} font-mono mx-auto grid `}>
              ...
              <div className={`${classes.card_divider} ${classes.card_div}  grid grid-cols-1 min-tb:max-tb:grid-cols-1 md:grid-cols-2  max-w-[1365px] mx-auto `}>
