                    ...
                    <div key={`${index}_GrowthEnginePage_Box_nested_1`}>
                      {index % 2 === 0 ? (
                        <div className={`${classes.growth_box_text_content} ${classes.growth_box_text_content_left} Our_values_main  md:max-w-[830px] md:pe-16`}>
                          ...
                          <p className="text-[#d3d3d3] md:text-base min-tb:max-tb:text-[12px] text-sm md:mt-[16px] mt-[10px] font-mono ">{item.belowLine}</p>

                          {item.buttonLink !== null &&
                            item.buttonName !== null && (
                              <Link
                                href={item.buttonLink}
                                className="font-mono font-normal group hover:bg-color-1 border border-white hover:text-white text-color-1 rounded-full bg-white min-tb:max-tb:text-[16px] text-[12px] sm:text-base py-[3px] ps-5 flex gap-2 items-center md:mt-[25px] min-tb:max-tb:mt-[20px] mt-[18px] w-max"
                              >
                                {item.buttonName}{" "}
                        ...
                        >
                          ...
                          <p
                            className={`${classes.Our_values_main_p} ms-auto  text-white font-medium  font-mono lg:text-30px md:text-25px min-tb:max-tb:text-[16px] min-tb:max-tb:leading-[20px] text-[12px]`}
                          >
                            {item.description}
                          </p>
                          <p className="text-[#d3d3d3] md:text-base min-tb:max-tb:text-[12px] text-sm md:mt-[16px] mt-[10px] font-mono">{item.belowLine}</p>
                          ...
                          {item.buttonLink !== null &&
                            item.buttonName !== null && (
                              <Link
                                href={item.buttonLink}
                                className="text-[12px] font-mono font-normal group ms-auto hover:bg-color-1 border border-white hover:text-white text-color-1 rounded-full bg-white min-tb:max-tb:text-[16px] sm:text-base py-[3px] ps-5 flex gap-2 items-center md:mt-[25px] min-tb:max-tb:mt-[20px] mt-[18px] w-max"
                              >
                                {item.buttonName}{" "}
