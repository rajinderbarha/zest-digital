    ...
    <>
      <div className={` mt-[66px] md:mb-36 sm:mb-[130px] mb-[90px] main_padding`}>
        <div className="main_container ">
          <div className={`${classes.growth_box} md:rounded-30px rounded-[20px]  xl:pt-[85px] lg:pt-[80px] md:pt-[65px] sm:pt-[50px] pt-[30px] pb-[1px] main_padding`}>
            <div className="max-w-[1520px] mx-auto  relative">
              <div>
                  ...
                  {data.growthContent.map((item: any, index: number) => (
                    <div key={`${index}_GrowthEnginePage_Box_nested_1`}>
                      {index % 2 === 0 ? (
                        ...
                        <div
                          className={`${classes.Our_values_main_2} ${classes.growth_box_text_content} ms-auto text-end md:max-w-[830px] md:ps-16 my-11`}
                        >
                ...
                <div className={`${classes.below_box_heading} mt-[100px] md:mt-[185px]  relative `}>
                  <Box_Title
