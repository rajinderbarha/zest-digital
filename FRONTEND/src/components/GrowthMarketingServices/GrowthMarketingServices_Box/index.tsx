                ...
                <div className={`${classes.single_container}`}>
                    ...
                    <div className="hidden md:flex   2xl:px-[259px] xl:px-[210px] lg:px-[180px]  px-[120px] justify-between ">
                        ...
                        <div className="text-center   max-w-[389px]">
                            ...
                            <h2 className='2xl:text-45px xl:text-40px lg:text-35px  text-30px text-color-7 font-mono font-semibold'>{props.image_1_title}</h2></div>
                    ...
                    <div className="mt-[150px] md:mt-[258px] mx-auto max-w-[1208px] mb-[35px]">
                        <h2 className='font-mono font-semibold text-25px sm:text-30px md:text-35px leading-10 lg:leading-normal lg:text-40px xl:text-45px text-white mx-auto text-center px-4 sm:px-20  pb-6'>{props.title} <span className='text-color-9'> {props.title_change_color}</span></h2>
                    </div>
