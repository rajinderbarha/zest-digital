    ...
    <>
      <div className="main_padding">
        <div className=" text-white main_container">
          ...
          <div className={`${classes.banner} grid md:grid-cols-2 grid-cols-1 gap-10 bg-color-1 bg-image-1 bg-no-repeat bg-cover md:rounded-30px rounded-[20px] xl:pb-[110px] lg:pb-[86px] xl:pt-[130px] lg:pt-[90px] md:pt-[90px] sm:pt-[50px] pt-[30px] md:pb-[150px] sm:pb-[50px] pb-[30px] main_padding relative`}>
