...
function Resources_Calculater_Step_1() {
    return (
        <>
            <div className="Resources_Calculater_Step_1">
                <div className="sm:px-10 px-5">
                    <div className="Resources_Calculater_Step_1 popup_conatiner pt-[29px] pb-[66px]   relative">
                        <div className="progrees_bar mb-[80px]">
                        ...
                        <div className=" text-center my-[38px] max-w-[1280px] mx-auto">
                            ...
                            <p className="font-mono text-30px font-normal text-center px-10 my-[53px]">Use our Growth Calculator to forecast how many visitors and what conversion rate you need to achieve, to hit your revenue goals.</p>
                        </div>
