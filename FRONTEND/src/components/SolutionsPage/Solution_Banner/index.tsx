            ...
            <div className={`${classes.Solution_Banner} main_padding`}>
                <div className='main_container'>
                    <div className="grid md:grid-cols-12 ">
                        ...
                        <div className="md:col-span-5 min-tb:max-tb:col-span-12 md:flex">
                            <Image className={`${classes.banner_image} rotate sm:max-w-fit md:ms-auto min-tb:max-tb:p-0 lg:p-[55px] md:p-[44px] md:ps-[75px]`} src={urlFor(data.image).url()} alt="banner img" width={350} height={350} />
                        </div>
                    </div>
                </div>
            </div>
