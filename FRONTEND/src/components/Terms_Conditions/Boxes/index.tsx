...
const Boxes: React.FC<BoxesProps> = (props) => {
    ...
    return (
        <div className={`${classes.growth_engine} ${props.shadow_right ? ` shadow-dark-pink-left ` : `shadow-blue-right`} w-full mx-auto ps-14 pe-7 py-[70px] rounded-[20px] md:rounded-30px border border-black  bg-white text-color-1`}>
