...
function Terms_Conditions({ data }: { data: { termsAndConditionData: TermsAndConditionsType[] } }) {
        ...
        <div key={index}>
          <div className='main_container'>
            <div className={`${classes.Careerbanner}`}>
              <div className="">
                <h1 className='font-mono font-semibold md:text-55px text-35px mb-5 '>{item.heading}</h1>
              </div>
            </div>
          </div>
          <div className="main_container">
