...
function Escape({ data }: { data: AboutType[] }) {
  ...
  return <div className="Escape_main main_padding xl:mt-[152px] lg:mt-[120px] md:mt-[95px] sm:mt-[70px] mt-[97px]  xl:mb-[122px] lg:mb-[100px] md:mb-[80px] sm:mb-[75px] mb-[80px]" data-aos="fade-up">
        ...
        <Link href={Escapedata.escape.careerPagelink}>
          <div className={`${classes.Escape} main_padding rounded-[20px] lg:rounded-[30px] xl:py-[130px] lg:my-[100px] md:py-[80px] min-tb:max-tb:pt-[70px] min-tb:max-tb:pb-[106px] sm:py-[60px] pt-[60px] pb-[86px]`}>
            <div className={`${classes.Escape_box}`}>
              <h2 className={`${classes.escape_heading} md:mb-12 sm:mb-[20px] mb-[18px] min-tb:max-tb:mb-[40px]  font-mono text-center  font-semibold text-white`} data-aos="fade-up" >
