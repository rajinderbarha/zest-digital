                            ...
                            <div key={`${item}_Zest_for_life`} >
                                <div className="grid md:grid-cols-12 ">
                                    <div className="md:col-span-9">
                                        ...
                                        <p className='font-mono max-w-[986px] font-semibold lg:text-35px md:text-30px sm:text-25px text-[20px] mb:mb-0 sm:mb-5 mb-[5px] text-color-1'>{item.lifeSection.description}</p>
