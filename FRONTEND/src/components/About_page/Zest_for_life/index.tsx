                    ...
                    <div key={`${item}_Zest_for_life`} >
                        <div className="grid grid-cols-12 " data-aos="fade-up">
                            <div className="min-tb:col-span-9 col-span-7">
                                ...
                                <p className={`${classes.zest_for_life_desc} font-mono  min-tb:max-tb:max-w-[435px] font-semibold mb:mb-0 sm:mb-5 mb-[5px] text-color-1`}>{item.lifeSection.description}</p>
                            </div>
                            <div className="min-tb:col-span-3  col-span-5" data-aos="zoom-in" data-aos-delay="200">
                                <Image className=' ms-auto  xl:max-w-[300px] lg:max-w-[250px] md:max-w-[200px] sm:max-w-[150px] min-tb:max-tb:max-w-[150px] max-w-[115px] w-full' src={urlFor(item.lifeSection.image).url()} width={300} height={300} alt="" />
                            </div>                    </div>
                                ...
                                if (path == 0) {
                                    return (
                                        <div className={`${classes.zest_for_life_facility} Zest_for_life_facility_image text-center md:max-w-fit max-w-[270px] mx-auto`} key={`${path}__Zest_for_life_path_0 `} data-aos="fade-up">
                                            ...
                                            <p className=' font-mono  font-normal lg:mt-8 md:mt-6 mt-4  md:px-8 px-[15px] max-w-[440px] mx-auto text-color-1'>{cardItem.description}</p>
                                        </div>
                                    )
                                }
                                else if (path == 1) {
