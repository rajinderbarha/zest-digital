...
// function Resource_Access_popup({ setStep, register, handleSubmit, setFormData, formTitle, sendDataToGoogleSheets }: any) {
...
//     return <form onSubmit={handleSubmit(async (data: any) => {
...
function Resource_Access_popup({ setStep, register, handleSubmit, setFormData, formTitle, sendDataToGoogleSheets, downloadUrls }: any) {
    const router = useRouter();
    const { popup } = router.query;
    ...
    const handleFormSubmit = async (data: any) => {
        ...
        if (popup === "/growthcalculator") {
            ...
            try {
                await sendDataToGoogleSheets(data); // Pass data if required
                sessionStorage.setItem('formSubmitted', 'true');
                document.cookie = "formSubmitted=true; path=/";
