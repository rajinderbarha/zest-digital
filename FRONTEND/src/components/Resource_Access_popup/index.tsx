        ...
        <form onSubmit={handleSubmit((data:any)=>{
            ...
            <div className="Resource_Access_popup ">
                <div className="sm:px-10 px-5">
                    ...
                    <div className="Resource_Access_popup popup_conatiner pt-[88px]  relative bg-white">
                        ...
                        <div className={`${classes.form_inputs} max-w-[1040px] mx-auto mt-[52px] flex justify-between px-5`}>
                            <div className="first_name flex flex-col w-full max-w-[300px]">
                                ...
                                <input type="text" name="fname" id="" className='border border-color-9 rounded-[10px] px-[25px] py-[14px] text-lg h-[50px]' placeholder='John' {...register("firstName")} />
                            </div>
                            <div className="last_name flex flex-col w-full max-w-[300px]">
                                ...
                                <input type="text" name="lname" id="" className='border border-color-9 rounded-[10px] px-[25px] py-[14px] text-lg h-[50px]' placeholder='Doe'{...register("lastName")} />
                            </div>
                            <div className="email flex flex-col w-full max-w-[300px]">
                                ...
                                <input type="email" name="email" id="" className='border border-color-9 rounded-[10px] px-[25px] py-[14px] text-lg h-[50px]' placeholder='johndoe@gmail.com' {...register("email")} />
                            </div>
                        </div>
                        <div className="button mt-[40px] text-center mb-[108px]">
                            <button className='bg-color-1 font-mono text-base px-[20px] py-[10px] text-white rounded-full' type='submit'>Get access</button>
                        </div>
