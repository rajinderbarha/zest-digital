...
function solutions({ solution }: { solution: SolutionProps[] }) {
  return <>
    ...
    <div className="Body_padding">
      ...
      <div className="xl:mt-[256px] lg:mt-[200px] md:mt-[150px] min-tb:max-tb:mb-[100px] min-tb:max-tb:mt-[200px] sm:mt-[140px] mt-[215px] xl:mb-[200px] lg:mb-[175px] md:mb-[130px] sm:mb-[70px] mb-[80px]">
