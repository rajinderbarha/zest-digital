        ...
        <div className="main_container ">
          ...
          >
            <div className="md:w-[654px] w-max  xl:pb-[218px] lg:pb-[160px] md:pb-[130px] pb-[50px]">
              <h2 className=" xl:text-45px lg:text-40px md:text-35px sm:text-30px text-[28px] text-white font-semibold xl:mb-[25px] lg:mb-[20px] md:mb-[15px] sm:mb-[10px] mb-[8px]">
                {data.title}
              </h2>
                  ...
                  <ul key={`${index}_servicesList`}>
                    <li>
                      ...
                      <Link
                        ...
                        className="border-b border-color-6  w-max text-md lg:text-lg flex items-center gap-1"
                      >
                        {item.title}
                        <GoArrowRight />
                      </Link>
