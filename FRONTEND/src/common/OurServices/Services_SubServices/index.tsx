    ...
    <>
      <div className={`${classes.GrowthMarketingServices_services} main_padding xl:mt-[170px] lg:mt-[150px] md:mt-[125px]  min-tb:max-tb:MT-[76px] sm:mt-[80px] mt-[68px]`}>
        <div className="main_padding">
                <div className="max-w-[1510px] w-full mx-auto xl:pt-[114px] lg:pt-[90px] md:pt-[70px] min-tb:max-tb:pt-[48px] sm:pt-[50px] pt-[39px] xl:pb-[165px] lg:pb-[130px]  pb-[102px]  md:px-[20px] min-tb:max-tb:px-[38px] sm:px-[15px] px-5  border border-color-1 rounded-[20px]  md:rounded-30px shadow-compo">
