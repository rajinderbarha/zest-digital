        ...
        <div className="main_container">
          ...
          >
            <div className="col-span-1 md:max-w-[558px] min-tb:max-tb:max-w-[420px] sm:max-w-[300px] max-w-[250px]  mx-auto">
              ...
              <h2 className={`${classes.address_heading} font-mono font-semibold text-color-9 text-center `}>
                {heading_add}
              </h2>
              ...
              <h2 className={`${classes.address_desc} font-mono  font-semibold text-white text-center   max-w-[566px] mx-auto`}>
                {slotDescription_add}
              </h2>
              <div className={`${classes.book_btn} bokk_now_btn`}>
