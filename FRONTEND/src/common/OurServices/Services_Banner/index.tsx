                    ...
                    <div className={`${max_width_string} `} >
                        <div className="md:pe-20 ">
                            ...
                            <div className="flex flex-wrap gap-4">
                                ...
                                <button className="font-mono text-[12px] sm:text-base md:px-21px sm:px-[18px] px-[15px] md:h-10 sm:h-[35px] h-[35px] text-white bg-color-1 rounded-full  hover:text-color-1 hover:bg-white  border border-color-1 ">{callButtonName}</button>
                                <button className="font-mono text-[12px] sm:text-base md:px-21px sm:px-[18px] px-[15px] md:h-10 sm:h-[35px] h-[35px] bg-white text-color-1 rounded-full  hover:bg-color-1 hover:text-white hover:border-black border border-color-1 ">{resultsButtonName}</button>
                            </div>
                        </div>
                    </div>
                </div>
